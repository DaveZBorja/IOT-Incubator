  ...
  String html = R"=====(
    ...
    <body onload="fetchData()">
      <div class="container">
        ...
        <input type="number" id="tempThreshold" placeholder="Temp Threshold" value="30.0">
        <input type="number" id="humidityThreshold" placeholder="Humidity Threshold" value="70.0">
